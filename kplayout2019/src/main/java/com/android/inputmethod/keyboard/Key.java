...
public class Key implements Comparable<Key> {
    ...
    public static final int BACKGROUND_TYPE_SYMBOLS = 7;
    public static final int BACKGROUND_TYPE_ALT = 8;
    public static final int BACKGROUND_TYPE_NUMERIC = 9;
    ...
    public Key(@Nullable final String label, final int iconId, final int code,
            ...
            final int width, final int height,  int horizontalGap,  int verticalGap) {
    ...
    private Key(@Nonnull final Key key, @Nullable final MoreKeySpec[] moreKeys) {
        ...
        mWidth = key.mWidth;
        mHeight = key.mHeight;
        mHorizontalGap = 0; //key.mHorizontalGap;
        mVerticalGap = 0; //key.mVerticalGap;
        mX = key.mX;
        mY = key.mY;
    ...
    static class KeyBackgroundState {
        ...
        public static final KeyBackgroundState[] STATES = {
            ...
            new KeyBackgroundState(),
            // 7: BACKGROUND_TYPE_SYMBOLS
            new KeyBackgroundState(),
            // 8: BACKGROUND_TYPE_ALT
            new KeyBackgroundState(),
            // 9: BACKGROUND_TYPE_NUMERIC
            new KeyBackgroundState(),
        };
    }
     ...
     */
    @Nonnull
    public final Drawable selectBackgroundDrawable(Drawable mKey_Qwerty,Drawable mKey_Numeric, Drawable mKey_Space, Drawable mKey_Functional, Drawable mKey_Symbols,Drawable mKey_Alt) {
         Drawable background;
        switch (mBackgroundType) {
            case BACKGROUND_TYPE_FUNCTIONAL : background = mKey_Functional; break;
            case BACKGROUND_TYPE_SPACEBAR : background = mKey_Space; break;
            case BACKGROUND_TYPE_SYMBOLS : background = mKey_Symbols; break;
            case BACKGROUND_TYPE_ALT : background = mKey_Alt; break;
            case BACKGROUND_TYPE_NUMERIC : background = mKey_Numeric;break;
            default: background = mKey_Qwerty;break;
        }
