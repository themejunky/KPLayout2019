...
import com.android.inputmethod.keyboard.emoji_themejunky.EmojIconActions;
import com.android.inputmethod.keyboard.emoji_themejunky.EmojiActionListener;
import com.android.inputmethod.keyboard.emoji_themejunky.EmojiCustomListener;
...
public final class KeyboardSwitcher implements KeyboardState.SwitchActions, EmojiActionListener, EmojiCustomListener {
    private static final String TAG = KeyboardSwitcher.class.getSimpleName();

    private InputView mCurrentInputView;
    private View mMainKeyboardFrame;
    private LinearLayout testare;
    private MainKeyboardView mKeyboardView;
    private EmojiPalettesView mEmojiPalettesView;
    private RelativeLayout mTjEmojiPalettesView;
    private LatinIME mLatinIME;
    private RichInputMethodManager mRichImm;
    private boolean mIsHardwareAcceleratedDrawingEnabled;
    private View mKeyBoardBackground;
    ...
    private boolean updateKeyboardThemeAndContextThemeWrapper(final Context context,
        ...
        if (mThemeContext == null || LatinIME.mNewTheme) {
    ...
    private void setMainKeyboardFrame(@Nonnull final SettingsValues settingsValues,@Nonnull final KeyboardSwitchState toggleState)
    {
        ...
        mTjEmojiPalettesView.setVisibility(View.GONE);
        mEmojiPalettesView.stopEmojiPalettes();
    }

    public void setMainKeyBoard() {
    ...
    public void setEmojiKeyboard() {
        ...
        mTjEmojiPalettesView.setVisibility(View.VISIBLE);

        EmojIconActions emojIconActions = new EmojIconActions(mThemeContext, mThemeContext, this);
        emojIconActions.ShowEmojIcon(mKeyboardView,mThemeContext,this,mTjEmojiPalettesView);
    }
    ...
    @Override
    public void customEmoji_Commit(String emoji) {
        mLatinIME.getCurrentInputConnection().finishComposingText();
        mLatinIME.getCurrentInputConnection().commitText(emoji, 0);
    }

    @Override
    public void customEmoji_BackSpace() {
        mLatinIME.onCodeInput(Constants.CODE_DELETE, NOT_A_COORDINATE, NOT_A_COORDINATE, false /* isKeyRepeat */);
        mLatinIME.onReleaseKey(Constants.CODE_DELETE, false /* withSliding */);
    }

    @Override
    public void customEmoji_Hide() {
        setMainKeyBoard();
    }
    ...
    public boolean isShowingKeyboardId(@Nonnull int... keyboardIds) {
        if (mKeyboardView == null || !mKeyboardView.isShown() || mKeyboardView.getKeyboard()==null) {
            return false;
        }
    ...
    public View onCreateInputView(final boolean isHardwareAcceleratedDrawingEnabled) {
        ...
        mTjEmojiPalettesView = (RelativeLayout) mCurrentInputView.findViewById(R.id.tj_emoji_palettes_view);
            //mTjEmojiPalettesView.setKeyboardActionListener(mLatinIME);

        mKeyBoardBackground = mMainKeyboardFrame.findViewById(R.id.mBackground);
            mKeyBoardBackground.setBackground(DefaultThemes.getmInstance().getCurrentTheme().keyboardBackground);
    ...
    public void openTM() {
        mLatinIME.startActivity(new Intent(mLatinIME, MainActivity.class));
    }
