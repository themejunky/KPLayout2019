...
public final class KeyDrawParams {
    ...
    public void updateParams(final int keyHeight, @Nullable final KeyVisualAttributes attr) {
        ...
        ThemeResource mKeyboardTheme = DefaultThemes.getmInstance().getCurrentTheme();
        ...
        mTextColor = mKeyboardTheme.keyLabel.normal.getColorForState(new int[]{},mTextColor);
        mTypeface = mKeyboardTheme.keyLabel.font;

        mFunctionalTextColor = mKeyboardTheme.keyLabel.normal.getColorForState(new int[]{},mFunctionalTextColor);
     ...
     //  mFunctionalTextColor = selectColor(attr.mFunctionalTextColor, mFunctionalTextColor);
        ...
        mPreviewTextColor = mKeyboardTheme.keyPreview.labelColor;
