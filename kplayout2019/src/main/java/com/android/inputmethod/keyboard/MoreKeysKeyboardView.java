...
public class MoreKeysKeyboardView extends KeyboardView implements MoreKeysPanel {
    ...
    public MoreKeysKeyboardView(final Context context, final AttributeSet attrs,
        ...
        mDivider = moreKeysKeyboardViewAttr.getDrawable(R.styleable.MoreKeysKeyboardView_divider2);
        if (mDivider != null) {
     ...
     protected void drawBackground(Canvas canvas) {
        mKeyboardTheme.moreKeys.background.setBounds(0,0,getWidth(),getHeight());
        mKeyboardTheme.moreKeys.background.draw(canvas);
    }
