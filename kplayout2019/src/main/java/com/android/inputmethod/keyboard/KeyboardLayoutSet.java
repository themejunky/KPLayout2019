...
public final class KeyboardLayoutSet {
    ...
    public Keyboard getKeyboard(final int baseKeyboardLayoutSetElementId) {
        ...
        case KeyboardId.MODE_PHONE:
            ...
            Log.d("sdadasdsda1","get?");
            break;
        case KeyboardId.MODE_NUMBER:
        case KeyboardId.MODE_DATE:
        case KeyboardId.MODE_TIME:
        case KeyboardId.MODE_DATETIME: keyboardLayoutSetElementId = KeyboardId.ELEMENT_NUMBER;     Log.d("sdadasdsda1","get?");     break;
        default:
            Log.d("sdadasdsda1","get");
    ...
    private Keyboard getKeyboard(final ElementParams elementParams, final KeyboardId id) {
        ...
        Log.d("sdadasdsda3","1 : "+sUniqueKeysCache);
        Log.d("sdadasdsda3","1 : "+(new KeyboardParams(sUniqueKeysCache).GRID_HEIGHT)+"/"+(new KeyboardParams(sUniqueKeysCache).GRID_WIDTH)+"/");
    ...
    public static final class Builder {
        ...
        public Builder setSubtype(@Nonnull final RichInputMethodSubtype subtype) {
            ...
            Log.d("hai-hai",""+mParams.mKeyboardLayoutSetName);
            return this;
        }
