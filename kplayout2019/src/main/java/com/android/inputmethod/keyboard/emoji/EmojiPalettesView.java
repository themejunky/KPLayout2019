...
public final class EmojiPalettesView extends LinearLayout implements OnTabChangeListener,
    ...
    private EmojiPalettesView mEmojiBackground;
    ...
    public EmojiPalettesView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        mSpacebarBackgroundId = keyboardViewAttr.getResourceId(R.styleable.KeyboardView_spacebarBackground, keyBackgroundId);
        ...
        builder.setKeyboardGeometry(ResourceUtils.getDefaultKeyboardWidth(res),mEmojiLayoutParams.mEmojiKeyboardHeight);
        final KeyboardLayoutSet layoutSet = builder.build();
        final TypedArray emojiPalettesViewAttr = context.obtainStyledAttributes(attrs,R.styleable.EmojiPalettesView, defStyle, R.style.EmojiPalettesView);
    ...
    private void addTab(final TabHost host, final int categoryId) {
      ...
      //  iconView.setBackgroundColor(Color.parseColor("#80ffffff"));
    ...
    protected void onFinishInflate() {
        ...
        mTheme = DefaultThemes.getmInstance().getCurrentTheme();
      ...
      //  tabWidget.setStripEnabled(mCategoryIndicatorEnabled);
        ...
        mDeleteKey.setBackground(mTheme.deleteSymbol);
        mDeleteKey.setTag(Constants.CODE_DELETE);
        mDeleteKey.setOnTouchListener(mDeleteKeyOnTouchListener);


        ((ImageView)findViewById(R.id.mDeleteBackroundImage)).setImageDrawable(mTheme.keyBackground.mKey_Functional);
        ((ImageView)findViewById(R.id.mBackBackroundImage)).setImageDrawable(mTheme.keyBackground.mKey_Functional);
       ...
       // mAlphabetKeyLeft.setBackgroundResource(mFunctionalKeyBackgroundId);
        ...
        mSpacebar.setBackground(mTheme.keyBackground.mKey_Space);
        ...
        mEmojiBackground = (EmojiPalettesView) findViewById(R.id.mEmojiBackground);
        mEmojiBackground.setBackground(mTheme.keyboardBackground);
    }
    ...
    public boolean onTouch(final View v, final MotionEvent event) {
        ...
        if (v==mSpacebar) {
            mSpacebar.setBackground(mTheme.keyBackground.mKey_Alt);
        }
