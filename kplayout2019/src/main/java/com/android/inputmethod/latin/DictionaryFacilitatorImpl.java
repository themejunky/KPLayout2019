...
public class DictionaryFacilitatorImpl implements DictionaryFacilitator {
    ...
    public void resetDictionaries(
        ...
        final boolean contactsPermissionGranted = PermissionsUtil.checkAllPermissionsGranted(context, Manifest.permission.READ_CONTACTS);
        ...
        Log.d("pasul_reset"," 5 : "+mDictionaryGroup);
        ...
        final DictionaryGroup dictionaryGroupForLocale =  findDictionaryGroupWithLocale(mDictionaryGroup, newLocale);
        final ArrayList<String> dictTypesToCleanupForLocale = existingDictionariesToCleanup.get(newLocale);
        ...
        for (final String subDictType : subDictTypesToUse) {
            ...
            if (noExistingDictsForThisLocale || !dictionaryGroupForLocale.hasDict(subDictType, account)) {
                // Create a new dictionary.
                Log.d("pasul_reset"," 5 : 1");

                subDict = getSubDict(subDictType, context, newLocale, null /* dictFile */, dictNamePrefix, account);
            } else {
                Log.d("pasul_reset"," 5 : 2");
        ...
        DictionaryGroup newDictionaryGroup = new DictionaryGroup(newLocale, mainDict, account, subDicts);
        ...
        for (final Locale localeToCleanUp : existingDictionariesToCleanup.keySet()) {
            ...
            final DictionaryGroup dictionarySetToCleanup =  findDictionaryGroupWithLocale(oldDictionaryGroup, localeToCleanUp);
...
*/
    ...
    public void addToUserHistory(final String suggestion, final boolean wasAutoCapitalized,
        ...
        Log.d("single_word","add -> "+suggestion);
    ...
    public void dumpDictionaryForDebug(final String dictName) {
        ...
        if (dictToDump == null) {
            Log.d("dumpDic", "Cannot dump " + dictName + ". "
