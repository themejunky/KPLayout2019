...
public final class Settings implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String PREF_ENABLE_PREDICTION =
            "pref_enable_prediction";
    ...
    public static final String PREF_ADD_SPACE_AUTOMATICALLY = "add_space_automatically"; // insert space after commas and periods
    ...
    public void loadSettings(final Context context, final Locale locale,@Nonnull final InputAttributes inputAttributes) {
        ...
        try {
            ...
            mSettingsValues.reloadTJ(mPrefs);
        } finally {
            mSettingsValuesLock.unlock();
        }
    }

    public void loadTJSettings() {
        if (getCurrent()!=null) {
        getCurrent().reloadTJ(mPrefs); }
    }
    ...
    public void savePrefByKeyFlag(String key, boolean flag) {
        SharedPreferences.Editor editor = mPrefs.edit();
        editor.putBoolean(key, flag);
        editor.apply();
    }

    public void savePrefByKeyFlag(String key, int flag) {
        SharedPreferences.Editor editor = mPrefs.edit();
