...
public class OnBoardingUtils {
    ...
    public static OnBoardingUtils instance = null;
    ...
    public OnBoardingUtils(Activity activity) {
        ...
        mHandler = new SettingsPoolingHandler((IntroTutorial) activity, mImmInHandler);
    }
    ...
    private final class SettingsPoolingHandler extends LeakGuardHandlerWrapper<IntroTutorial> {
        ...
        SettingsPoolingHandler(final IntroTutorial ownerInstance, final InputMethodManager imm) {
            super(ownerInstance);
            mImmInHandler = imm;
        }
        ...
        public void handleMessage(final Message msg) {
            final IntroTutorial setupWizardActivity = getOwnerInstance();
